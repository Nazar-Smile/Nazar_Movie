...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ActorView',
            fields=[
                ('genre_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='movies.genre')),
            ],
            bases=('movies.genre', django.views.generic.detail.DetailView),
        ),
        migrations.CreateModel(
            name='Reviews',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='comments', to='movies.movie', verbose_name='Пост')),
            ],
            options={
